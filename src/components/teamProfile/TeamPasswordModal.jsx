// src/components/teamProfile/TeamPasswordModal.jsx
import React, { useState } from 'react';
import { FiX, FiEye, FiEyeOff } from 'react-icons/fi';

const TeamPasswordModal = ({ show, onClose, onSubmit }) => {
  ...
  const validate = () => {
    ...
    else if (form.newPass.length < 6) e.newPass = 'Min 6 chars';
...
export default TeamPasswordModal;