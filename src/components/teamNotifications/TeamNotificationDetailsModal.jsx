// src/components/teamNotifications/TeamNotificationDetailsModal.jsx
...
const TeamNotificationDetailsModal = ({ show, onClose, notification, onAlert }) => {
  ...
  return (
    <div className="modal-overlay"><div className="modal-dialog"><div className="modal-content">
      ...
      <div className="modal-body">
        <div className="tn-detail-badges"><TeamNotificationTypeBadge type={notification.type} /><TeamNotificationStatusBadge status={notification.status} isRead={notification.isRead} /></div>
        ...
        <div className="mt-3 d-flex gap-2">
          <button className="btn btn-sm btn-outline-primary" onClick={() => onAlert('Go to Task is demo.')}>Go to Task</button>
          <button className="btn btn-sm btn-outline-primary" onClick={() => onAlert('Go to Project is demo.')}>Go to Project</button>
        </div>
      </div>
...
export default TeamNotificationDetailsModal;